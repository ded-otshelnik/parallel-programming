...
+ [Регистровые переменные](3rd-task.md#Регистровые-переменные)
...
+ [Макроподстановки](3rd-task.md#Макроподстановки)
...
**Макроподстановки** - удобный способ сократить объем кода или сделать более удобочитаемым.
