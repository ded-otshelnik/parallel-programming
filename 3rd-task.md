...
<img src="images/memory&structs/memory_allocation.png" alt="pointers" width="500"/>
...
+ Все задачи, где применяются массивы, должны быть реализованы с использованием функций управления памятью.

1. Дана структура *Date* и перечисление *DayOfWeek*:
...
3. Дана структура, описывающая стек (размер стека изначально числом *N*):
